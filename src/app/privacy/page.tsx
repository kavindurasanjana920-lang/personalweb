    ...
    <main className="min-h-dvh">
      <div className="space-y-10">
        ...
        <Section id="data-collection" title="Collecting and Using Your Personal Data">
          ...
          <SubSection title="Usage Data">
            <p>
              ...
              <span className="text-foreground font-medium">Google Tag Manager (GTM-W83VHS8G)</span>{" "}
        ...
        <Section id="contact" title="Contact Us">
          ...
          <div className="rounded-xl border border-border bg-card/40 p-5 space-y-2 mt-2">
