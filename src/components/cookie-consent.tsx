    ...
    <>
      ...
      {!bannerVisible && (
        <button
          ...
          className="fixed bottom-6 right-4 z-[150] flex items-center justify-center size-9 rounded-full bg-card border border-border text-muted-foreground shadow-md hover:text-foreground hover:bg-accent transition-colors sm:hidden"
        >
